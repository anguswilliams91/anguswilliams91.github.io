...
Now let's Taylor expand the log posterior, which I'll write as $$f(\theta)$$, around this point.
...
We can match up the terms in the expressions for $$g(\theta)$$ and the Taylor expansion of $$f(\theta)$$ to see that
